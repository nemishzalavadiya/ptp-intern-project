...
export default function Statistics(props) {
  return props.assetClass == "STOCK" ? (
    <div>
      <h2 className="ui header" style={{color: "white"}}>Statistics</h2>
      <section>
      ...
      <div className={styles.about}>
        <h2 className="ui header" style={{color: "white"}}>About</h2>
      ...
      <br/>
      <div className={styles.about}>
        <h2 className="ui header" style={{color: "white"}}>Managing Director</h2>
        <h3 className="ui header" style={{color: "white"}}>
    ...
    <div>
      ...
      <br/>
      <div className={styles.about}>
        <h2 className="ui header" style={{color: "white"}}>Fund Manager</h2>
        <h3 className="ui header" style={{color: "white"}}>{props.mfDetail.mutualFundDetail.fundManager}</h3>
      </div>
    </div>
  );
}
