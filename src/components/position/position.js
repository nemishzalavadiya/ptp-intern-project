...
export default function Position()
{
  ...
  function handleSearchChange(e, data) {
    ...
    return(
    <div>
    <Tab  content={tabs} handleItemClick={handleItemClick} activeItem={activeItem}></Tab>
    <Search
      ...
      />
    {
      ...
      activeItem===0 ?<StockPositionList value={value} page={page} handlePaginationChange={handlePaginationChange}></StockPositionList>:
      <MutualFundPosition value={value} page={page}  handlePaginationChange={handlePaginationChange}/>
