...
class OrderControllerTest {
    ...
    void addToStockOrder() {
        StockOrder stockOrder = new StockOrder(UUID.randomUUID(), LocalDateTime.now(),100,Action.BUY,StockExchangeType.BSE, PriceType.MARKET,OrderType.DELIVERY, (float)Math.random(),"EXECUTED",new User(UUID.fromString("96312e56-e122-4fa4-b0ec-c8afa80d6779"),"hash"," "," "," "," "," ", Gender.MALE,"Hash"),new StockDetail());
