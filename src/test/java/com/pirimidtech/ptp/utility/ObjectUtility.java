...
public class ObjectUtility {
    ...
    public static MutualFundOrder mutualFundOrder1 = new MutualFundOrder(UUID.fromString("06f51c63-14f3-4c34-be12-ec1abd26c957"), date1,0, 100f, InvestmentType.MONTHLY_SIP, mutualFundDetail, user);
    public static MutualFundOrder mutualFundOrder2 = new MutualFundOrder(UUID.fromString("f0108f8a-0d7c-4235-bce3-5deda9a3e151"), date1,0, 105f, InvestmentType.MONTHLY_SIP, mutualFundDetail, user);
