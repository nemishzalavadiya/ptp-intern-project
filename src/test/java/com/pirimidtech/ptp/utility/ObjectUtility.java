...
public class ObjectUtility {
    ...
    public static User user = new User(UUID.fromString("00000000-0000-0000-0000-000000000000"),"1234567812345678","user","encryptedPassword", "XYZ", "email", "panCard", "mobileNo", "signature", "dataOfBirth", Gender.MALE, "dpUrl");
    ...
    public static MutualFundOrder mutualFundOrder1 = new MutualFundOrder(UUID.fromString("06f51c63-14f3-4c34-be12-ec1abd26c957"), date1, 0, 100f, Status.PENDING, InvestmentType.MONTHLY_SIP, mutualFundDetail, user);
    public static MutualFundOrder mutualFundOrder2 = new MutualFundOrder(UUID.fromString("f0108f8a-0d7c-4235-bce3-5deda9a3e151"), date1, 0, 105f, Status.PENDING, InvestmentType.MONTHLY_SIP, mutualFundDetail, user);
