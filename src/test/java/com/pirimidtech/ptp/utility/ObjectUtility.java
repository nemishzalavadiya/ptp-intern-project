...
public class ObjectUtility {
    ...
    public static User user = new User(UUID.fromString("df02081e-db56-4ae4-b477-7ac0833344d2"),"XYZ","email","panCard","mobileNo","signature","dataOfBirth",Gender.MALE,"dpUrl");
    ...
    public static MutualFundDetail mutualFundDetail = new MutualFundDetail(UUID.fromString("95d9a220-2579-4a13-b7e2-7ac628ed2e6e"), null,"ABC", assetDetail);
    ...
    public static StockDetail stockDetail = new StockDetail(UUID.fromString("981a7cd2-feaf-4e29-8a77-f37ed75a6102"), null,"nemish", assetDetail);
